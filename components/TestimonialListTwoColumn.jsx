...
import QuotesLeftIcon from '../public/images/icons/quotes-l.svg';
import QuotesRightIcon from '../public/images/icons/quotes-r.svg';
import ArrowLeftIcon from '../public/images/icons/arrow-left-2-icon.svg';
import ArrowRightIcon from '../public/images/icons/arrow-right-2-icon.svg';
import SvgDecoratorBlob1 from '../public/images/icons/svg-decorator-blob-4.svg';
import SvgDecoratorBlob2 from '../public/images/icons/svg-decorator-blob-5.svg';
...
const TestimonialListTwoColumn = ({testimonials}) => {
    return (
        <Container>
            <Content>
                <HeadingInfoContainer>
                    <HeadingTitle>The Serve Experience</HeadingTitle>
                </HeadingInfoContainer>
...
export default TestimonialListTwoColumn;
