...
import {ReactComponent as SvgDotPatternIcon} from '../public/images/icons/dot-pattern.svg';
        ...
        <Container>
            <SingleColumn>
                <HeadingInfoContainer>
                    ...
                    <HeadingDescription>
                        Here are some of our upcoming events. Reach out to us for more information.
                    </HeadingDescription>
                </HeadingInfoContainer>

                <Content>
                    {events.map((event, i) => (
                        <Card key={event.id} reversed={i % 2 === 1}>
                            <Image imageSrc={event.poster.url}/>
                            <Details>
